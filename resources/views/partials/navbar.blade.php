            ...
            @auth
                                    ...
                                    <div class="dropdown-item">
                                        <div class="media server-log">
                                            ...
                                            <div class="media-body">
                                                <div class="data-info">
                                                    <h6 class="">{{ $mycommunity->name }}</h6>
                                                    <p class="">{{ $mycommunity->email }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="drodpown-title notification mt-2">
                                <a href="{{ route('create.community') }}">
                                    <h6 class="d-flex justify-content-between"><span class="align-self-center">Create
                                            Community</span> <span class="badge badge-secondary">+ New</span></h6>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                        ...
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators ">
                                <img alt="avatar" src="{{ url('/') }}/{{ Auth::user()->profile_photo_path }}"
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        ...
                        <div class="dropdown-item">
                            <a href="{{ url('dashboard/profile/admin') }}">
