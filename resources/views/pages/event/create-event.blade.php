...
@push('scripts')
    ...
    <script>
        ...
        newInput.addEventListener('click', () => {
            inputContainer.innerHTML += `<tr><div class="col-xxl-12 mb-4 mt-4">
                                <input type="text" class="form-control" id="post-meta-title" required placeholder="give a placeholder" name="custom_input[`+ i +`][title]">
                                <div class="col-xxl-12 mb-4 mt-4">
                                    <div class="switch form-switch-custom switch-inline form-switch-primary">
                                        <input class="switch-input" type="checkbox" role="switch" id="showPubliclyy[`+ i +`]" checked name="custom_input[`+ i +`][type]">
                                        <label class="switch-label" for="showPubliclyy[`+ i +`]">Required</label>
                ...
                <div class="row mb-4 layout-spacing layout-top-spacing">
                    ...
                    <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="widget-content widget-content-area blog-create-section mt-4">
                            ...
                            <h5 class="mb-4">creating questions</h5>
