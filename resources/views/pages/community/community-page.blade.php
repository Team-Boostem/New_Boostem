...
@push('styles')
    <style>
        ...
        .social-icons-container a svg:hover{
          transition: 0.5s;
          transform: scale(1.1);
        }
        .about-container{
...
@section('content')
    <div class="main-box">
        ...
        <div class="banner-container">
            ...
            {{-- /////about section ends heare --}}
            {{-- social media section starts heare --}}
            <div class="social-container">
                <h3>stay connected!...</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus autem nam ea fugiat similique eaque,
                    ad sequi quibusdam dolorem molestias inventore? Quo maxime at voluptatum tempora adipisci ea
            ...
            {{-- ///////social media section ends heare --}}
        </div>
    @endsection
