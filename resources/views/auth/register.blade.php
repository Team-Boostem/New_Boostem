                ...
                <div class="login-form">
                    ...
                    <form method="POST" action="{{url('/register')}}">
                        ...
                        <div class="form__group field">
                            <input type="text" autocomplete="name" class="form__field" placeholder="Name"  name="name" id="name"
                            :value="old('name')" required autofocus  />
                            <label for="name" class="form__label">name</label>
                        </div>
                        <div class="form__group field">
                            <input type="email" autocomplete="email" class="form__field" placeholder="Name" name="email" id="email"
                            :value="old('email')"  required />
                            <label for="email" class="form__label">Email</label>
                        </div>
                        <div class="form__group field">
                            <input type="password" autocomplete="new-password" class="form__field" placeholder="Name" name="password" id="password"
                                required />
                            <label for="password" class="form__label">Password</label>
                        </div>
                        <div class="form__group field">
                            <input type="password" autocomplete="new-password" class="form__field" placeholder="Name" name="password_confirmation" id="password_confirmation"
                                required />
